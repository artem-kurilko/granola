            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <divПродолжаю реализацию формы оплаты с интеграцией LiqPay:

<dyad-write path="src/pages/Checkout.tsx" description="Completing the checkout page with real payment integration">
"use client";
              ...
              <CardFooter>
                {paymentMethod === "liqpay" ? (
                  <LiqPayWidget
                    ...
                    orderId={orderId}
                    publicKey={import.meta.env.VITE_LIQPAY_PUBLIC_KEY || "your_public_key_here"}
                    privateKey={import.meta.env.VITE_LIQPAY_PRIVATE_KEY || "your_private_key_here"}
